...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Edit Category - ${ category.name }</h2>
  			<hr />
  			...
  			<form:form class="" method="POST" modelAttribute="category">
  				...
  				<input type="submit" class="btn btn-success" value="Save" /> &nbsp;&nbsp;<a href="/admin/categories/delete/${ category.categoryId }" class="btn btn-danger">Delete</a>
  			</form:form>			
