...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Add Product</h2>
  			<hr />
  			
  			<form:form class="" method="POST" modelAttribute="product">
				  ...
				  <form:input path="price" type="number" step="0.01" min="0" class="form-control" aria-label="Amount (to the nearest dollar)" />
				</div>
				<form:input class="form-control" path="description" placeholder="Description" /><br />
  				<div class="input-group mb-3">
				  <div class="input-group-prepend">
				    <label class="input-group-text" for="inputGroupSelect01">Category</label>
				  </div>
				  <form:select path="categoryId" class="custom-select" id="inputGroupSelect01">
				    <c:forEach var="category" items="${ categories }">
  						<form:option value="${ category.categoryId }" label="${ category.name }" />
  					</c:forEach>
				  </form:select>
				</div>
