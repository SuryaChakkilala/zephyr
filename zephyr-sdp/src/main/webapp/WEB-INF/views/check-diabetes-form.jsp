	        ...
	        <div class="col-lg-8">
	          ...
	          <form:form method="POST" modelAttribute="dto">
	            ...
	            <div class="form-outline mb-4">
	              <form:input path="glucose" min="0.0" type="number" step="any" id="form3Example3" class="form-control" />
	              <label class="form-label" for="form3Example3">Glucose Level</label>
	            </div>
	            
	            <div class="form-outline mb-4">
	              <form:input path="bloodPressure" min="0.0" type="number" step="any" id="form3Example3" class="form-control" />
	              <label class="form-label" for="form3Example3">Blood Pressure</label>
	            </div>
	            
	            <div class="form-outline mb-4">
	              <form:input path="skinThickness" min="0.0" type="number" step="any" id="form3Example3" class="form-control" />
	              <label class="form-label" for="form3Example3">Skin Thickness</label>
	            </div>
	            
	            <div class="form-outline mb-4">
	              <form:input path="insulin" type="number" min="0.0" step="any" id="form3Example3" class="form-control" />
	              <label class="form-label" for="form3Example3">Insulin</label>
	            </div>
	            
	            <div class="form-outline mb-4">
	              <form:input path="bmi" type="number" step="any" min="0.0" id="form3Example3" class="form-control" />
	              <label class="form-label" for="form3Example3">BMI</label>
	            </div>
	            
	            <div class="form-outline mb-4">
	              <form:input path="age" type="number" step="any" min="0.0" id="form3Example3" class="form-control" />
