...
<html>
  ...
  <br /><br />
  	...
  	<h1>Edit Query - ${ query.id }</h1>
  <hr />
  		<form:form method="POST" modelAttribute="query">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Name</label>
      <form:input path="name" type="text" class="form-control" id="inputEmail4" placeholder="Your name" />
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail4">Email</label>
      <form:input path="email" type="email" class="form-control" id="inputEmail4" placeholder="Your email address" />
    </div>
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Your Query</label>
    <form:textarea path="queryString" class="form-control" id="exampleFormControlTextarea1" rows="3"></form:textarea>
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Reply</label>
    <form:textarea path="reply" class="form-control" id="exampleFormControlTextarea1" rows="3"></form:textarea>
  </div>
  <form:hidden path="id" />
