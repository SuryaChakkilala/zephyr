...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Edit User - ${ user.username }</h2>
  			<hr />
  			
  			<form:form class="" method="POST" modelAttribute="user">
  				<form:input class="form-control" path="firstName" placeholder="First Name" /><br />
  				<form:input class="form-control" path="lastName" placeholder="Last Name" /><br />
  				Gender: &nbsp;&nbsp;<form:radiobutton path="gender" value="Male" />&nbsp;Male&nbsp;&nbsp;
  				<form:radiobutton path="gender" value="Female" />&nbsp;Female<br /><br />
  				<form:input class="form-control" path="email" type="email" placeholder="Email"/><br />
  				...
  				<form:password class="form-control" path="matchingPassword" placeholder="Confirm Password" /><br />
  				<input type="submit" class="btn btn-success" value="Save" />&nbsp;&nbsp;<a href="/admin/users/delete/${ id }"><button type="button" class="btn btn-danger">Delete</button></a>
  			</form:form>			
