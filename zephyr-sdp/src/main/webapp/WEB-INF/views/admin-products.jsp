...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Manage Products</h2>
  			<hr />
  			<div class="d-grid gap-2 d-md-flex justify-content-md-end my-2">
			  <a class="btn btn-success" href="/admin/products/add"><i class="bi bi-plus-circle"></i>&nbsp;&nbsp;Add Product</a>
			</div>
  			<table class="table">
			  ...
			  <tbody>
			    <c:forEach var="product" items="${ products }">
			    	<tr>
			    		...
			    		<td><a href="/admin/products/edit/${ product.productId }">Edit</a></td>
