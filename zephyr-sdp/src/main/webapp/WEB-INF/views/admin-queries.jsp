...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Manage Queries</h2>
  			<hr />
  			<table class="table">
			  ...
			  <tbody>
			    <c:forEach var="query" items="${ queries }">
			    	<tr>
			    		...
			    		<td>${ query.email }</td>
			    		<td>${ query.reply }</td>
 			    		<td><a href="/admin/queries/edit/${ query.id }">Edit<i class="bi bi-pencil-square"></i></a></td> 
			    		<td><a href="/admin/queries/delete/${ query.id }">Delete<i class="bi bi-trash-fill"></i></a></td>
			    	</tr>
			    </c:forEach>
			  </tbody>
			</table>
