...
<html>
  ...
  <div class="thankyou-page">
    ...
    <div class="_body">
        <div class="_box">
            <h2>
                <strong>Your Order will be shipped soon!</strong> 
            </h2>
            <p>
                The product will be delivered to you through our courier service.</p>
        </div>
    </div>
    <div class="_footer">
        <p>Having trouble? <a href="nokitchenfood1@gmail.com">Contact us</a> </p>
...
.thankyou-page ._header {
    padding: 100px 30px;
    text-align: center;
    background: #8a3a34 url(https://codexcourier.com/images/main_page.jpg) center/cover no-repeat;
}
