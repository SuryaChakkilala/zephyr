...
<html>
    ...
    <div class="container-fluid">
  	...
  	<div class="container justify-content-center">
  		<div class="m-4">
  			<br />
  			<h2 style="margin-left: 13%">Manage Categories</h2>
  			<hr />
  			<div class="d-grid gap-2 d-md-flex justify-content-md-end my-2">
			  <a class="btn btn-success" href="/admin/categories/add"><i class="bi bi-plus-circle"></i>&nbsp;&nbsp;Add Category</a>
			</div>
  			<table class="table">
			  ...
			  <tbody>
			    <c:forEach var="category" items="${ categories }">
			    	<tr>
			    		...
			    		<td><a href="/admin/categories/edit/${ category.categoryId }">Edit</a></td>
			    		<td><a href="/admin/categories/delete/${ category.categoryId }">Delete</a></td>
			    	</tr>
			    </c:forEach>
			  </tbody>
			</table>
